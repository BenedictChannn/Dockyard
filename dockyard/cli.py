        ...
        Panel.fit(
            "\n".join(
                [
                    ...
                    f"checkpoint_id: {_safe_preview(item.checkpoint_id or '', 180, fallback='(none)')}",
                    ...
                    f"notes: {_safe_preview(item.notes or '', 240, fallback='(none)')}",
                    f"files: {_safe_preview(', '.join(_coerce_text_items(item.files)), 240, fallback='(none)')}",
                ]
            ),
            title="Review Item",
            border_style="yellow",
