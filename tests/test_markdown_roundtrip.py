...
def test_markdown_parser_ignores_malformed_plain_backtick_resume_lines() -> None:
    """Parser should ignore malformed plain backtick resume command lines."""
    markdown = """# Checkpoint
## Objective
Objective text
## Decisions/Findings
...
def test_markdown_parser_ignores_structural_separators_in_plain_resume_lines() -> None:
    """Parser should ignore markdown separator/fence lines in plain commands."""
    markdown = """# Checkpoint
## Objective
Objective text
## Decisions/Findings
...
def test_markdown_parser_ignores_structural_separators_in_plain_next_steps() -> None:
    """Parser should ignore markdown separator/fence lines in plain next steps."""
    markdown = """# Checkpoint
## Objective
Objective text
## Decisions/Findings
...
def test_markdown_parser_ignores_extended_structural_separator_lines() -> None:
    """Parser should ignore structural separator/fence lines with 4+ markers."""
    markdown = """# Checkpoint
## Objective
Objective text
## Decisions/Findings
...
def test_markdown_parser_accepts_deeper_atx_heading_levels() -> None:
    """Parser should resolve known section headings at level 3+ ATX depth."""
    markdown = """# Checkpoint
### Objective
Objective text
#### Decisions/Findings
...
def test_markdown_parser_accepts_hyphenated_decisions_heading_aliases() -> None:
    """Parser should accept hyphenated decisions/findings heading aliases."""
    markdown = """# Checkpoint
## Objective
Objective text
## Decision-Finding
...
def test_markdown_parser_accepts_ampersand_decisions_heading_aliases() -> None:
    """Parser should accept ampersand decisions/findings heading aliases."""
    markdown = """# Checkpoint
## Objective
Objective text
## Decision & Finding
...
def test_markdown_parser_accepts_space_separated_decisions_heading_aliases() -> None:
    """Parser should accept space-separated decisions/findings heading aliases."""
    markdown = """# Checkpoint
## Objective
Objective text
## Decision Finding
...
def test_markdown_parser_accepts_tight_separator_heading_aliases() -> None:
    """Parser should accept tight `&`/`-` heading separator forms."""
    markdown = """# Checkpoint
## Objective
Objective text
## Decision&Finding
...
def test_markdown_parser_accepts_symbolic_next_resume_heading_aliases() -> None:
    """Parser should accept symbolic delimiters in next/resume headings."""
    markdown = """# Checkpoint
## Objective
Objective text
## Decisions/Findings
...
def test_markdown_parser_accepts_unicode_dash_separator_heading_aliases() -> None:
    """Parser should accept en/em-dash separated heading alias forms."""
    markdown = """# Checkpoint
## Objective
Objective text
## Decision—Finding
...
def test_markdown_parser_accepts_plus_separator_heading_aliases() -> None:
    """Parser should accept plus-separated heading alias forms."""
    markdown = """# Checkpoint
## Objective
Objective text
## Decision+Finding
...
def test_markdown_parser_accepts_ampersand_risks_heading_alias() -> None:
    """Parser should accept `Risks & Review Needed` heading alias."""
    markdown = """# Checkpoint
## Objective
Objective text
...
def test_markdown_parser_accepts_space_separated_risks_heading_alias() -> None:
    """Parser should accept `Risks Review Needed` heading alias."""
    markdown = """# Checkpoint
## Objective
Objective text
...
def test_markdown_parser_accepts_wrapped_markdown_heading_labels() -> None:
    """Parser should resolve known headings wrapped in basic markdown markup."""
    markdown = """# Checkpoint
## **Objective**
Objective text
...
def test_markdown_parser_accepts_nested_wrapped_heading_labels() -> None:
    """Parser should resolve known headings wrapped in nested markdown markers."""
    markdown = """# Checkpoint
## **`Objective`**
Objective text
## __`Decisions/Findings`__
Decision text
## `**Next Steps**`
1. Keep moving
## *`Risks/Review Needed`*
...
def test_markdown_parser_stops_list_capture_on_deeper_unknown_headings() -> None:
    """Unknown level-3+ headings should terminate list-section parsing."""
    markdown = """# Checkpoint
## Objective
Objective text
## Decisions/Findings
