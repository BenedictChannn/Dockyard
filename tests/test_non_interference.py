...
def _build_outside_repo_read_only_commands(repo_name: str, base_branch: str) -> list[list[str]]:
    ...
    return [
        ["python3", "-m", "dockyard", "resume", repo_name],
        ["python3", "-m", "dockyard", "resume", repo_name, "--json"],
        ["python3", "-m", "dockyard", "resume", repo_name, "--handoff"],
        ["python3", "-m", "dockyard", "resume", repo_name, "--branch", base_branch],
        ["python3", "-m", "dockyard", "resume", repo_name, "--branch", base_branch, "--json"],
        ["python3", "-m", "dockyard", "resume", repo_name, "--branch", base_branch, "--handoff"],
        ...
        ["python3", "-m", "dockyard", "search", "baseline", "--repo", repo_name],
        ...
        ["python3", "-m", "dockyard", "search", "baseline", "--tag", "baseline", "--repo", repo_name, "--json"],
        [
            "python3",
            "-m",
            "dockyard",
        ...
        ["python3", "-m", "dockyard", "search", "baseline", "--repo", repo_name, "--branch", base_branch, "--json"],
        ...
        ["python3", "-m", "dockyard", "f", "baseline", "--repo", repo_name, "--branch", base_branch, "--json"],
        ["python3", "-m", "dockyard", "f", "baseline", "--tag", "missing-tag"],
        ["python3", "-m", "dockyard", "f", "baseline", "--tag", "baseline"],
        ["python3", "-m", "dockyard", "f", "baseline", "--tag", "baseline", "--repo", repo_name],
        ["python3", "-m", "dockyard", "f", "baseline", "--tag", "baseline", "--repo", repo_name, "--json"],
        [
            "python3",
            "-m",
            "dockyard",
